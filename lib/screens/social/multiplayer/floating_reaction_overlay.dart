...
class FloatingReactionOverlay extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FloatingReactionOverlay> createState() => FloatingReactionOverlayState();
}

class FloatingReactionOverlayState extends ConsumerState<FloatingReactionOverlay> with TickerProviderStateMixin {
  ...
  void spawnEmoji(String emoji) {
    ...
    setState(() {
      _emojis.add(_FloatingEmoji(
        id: id,
        emoji: emoji,
        left: random.nextDouble() * MediaQuery.of(context).size.width * 0.8 + 20,
