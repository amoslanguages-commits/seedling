...
class _LiveChatOverlayState extends ConsumerState<LiveChatOverlay> {
  ...
  void _sendMessage() {
    ...
    ref
        ...
        .sendChatMessage(_controller.text.trim());
    _controller.clear();
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      ...
      right: 20,
      child: _isOpen
          ? _buildExpandedChat(messages)
          : _buildMinimisedBubble(messages),
    );
  }
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: SeedlingColors.water.withValues(alpha: 0.4),
                  blurRadius: 10,
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final userId = auth.value?.session?.user.id;
                    ...
                    return Container(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: isMe
                                ? SeedlingColors.water.withValues(alpha: 0.5)
                                : Colors.transparent,
                          ),
                        ),
                        child: Column(
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: SeedlingTypography.body.copyWith(
                            color: SeedlingColors.textSecondary,
                          ),
                          filled: true,
